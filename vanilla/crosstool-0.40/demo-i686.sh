...
#eval `cat i686.dat gcc-4.1-20050522-glibc-2.3.5-hdrs-2.6.11.2.dat` sh all.sh --notest
#eval `cat i686.dat gcc-4.1-20050702-glibc-2.3.5-hdrs-2.6.11.2.dat` sh all.sh --notest
#eval `cat i686.dat gcc-4.1-20050709-glibc-2.3.2-hdrs-2.6.11.2.dat` sh all.sh --notest --testlinux
